...
const FirstRoute = () => (
  <View style={{ /* flex: 1, */height: 400, backgroundColor: '#ff4081' }} />
);
...
export const UnauthAddAccountBrandReviewScreen: FC<UnauthAddAccountBrandReviewScreenProps> = observer(
  function UnauthAddAccountBrandReviewScreen(
  _props,
) {
