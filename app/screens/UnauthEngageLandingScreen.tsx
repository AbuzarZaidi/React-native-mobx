...
export const UnauthEngageLandingScreen: FC<UnauthEngageLandingScreenProps> = observer(function UnauthEngageLandingScreen(_props) {
        ...
        >
          <View style={$primarySlide}>
            ...
            >
              ...
              <Image
                source={require('../../assets/images/BrandLogo_214x133.png')}
              />
              <Text style={styles.text}>We offer the easiest way to value, track and monetize personal brands and businesses so they can grow.
              </Text>
            </View>
            <View
              style={$buttonsStyle}
